...
export const CloseIcon = ({ className, width = '16', height = '16' }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const LookupIcon = ({ className, width = '2.4rem', height = '2.4rem' }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const HomeAcitveIcon = ({ className, width = '3.2rem', height = '3.2rem' }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const LiveAcitveIcon = ({ className, width = '3.2rem', height = '3.2rem' }) => {
    return (
        <svg
            className={className}
            width={width}
